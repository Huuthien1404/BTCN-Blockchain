  ...
  return (
    <div className="bg-primary-gray px-6 py-[100px]">
      <div className="bg-white mx-auto md:w-[600px] lg:w-[800px] rounded-md">
        <div className="bg-violet text-white p-6 rounded-t-md">
          <h1 className="text-xl font-bold text-center uppercase">Access My Wallet</h1>
        </div>
                ...
                <div className="flex flex-col gap-5">
                  <div className="bg-primary-warning flex flex-wrap justify-center md:justify-between gap-3 px-6 py-4">
                    ...
                    <div className="w-[100%] md:w-[80%] flex flex-col gap-3">
                      ...
                      <div className="font-bold flex items-center gap-2">
                        <p>Read</p>
                        <p className="text-violet underline">
                          Using MEW offline
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    className={`flex items-center justify-between gap-3 p-4 rounded-md border-2
                                hover:cursor-pointer hover:border-violet ${
                                  accessType === "keystore"
                                    ? "border-violet"
                                    : "border-gray-200"
                                }`}
                  ...
                  >
                    ...
                    {accessType === "keystore" && (
                      <FaCheckCircle className="text-violet" size={40} />
                    )}
                  </div>
                  <div
                    className={`flex items-center justify-between gap-3 p-4 rounded-md border-2
                  ...
                  <p className="text-center text-violet font-bold">
